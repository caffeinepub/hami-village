...
const BREATHE_PHASES = [
  { label: "Inhale...", duration: 4e3 },
  { label: "Hold...", duration: 2e3 },
  { label: "Exhale...", duration: 4e3 },
  { label: "Rest...", duration: 2e3 }
];
const BREATHE_CSS = {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "12", height: "12", viewBox: "0 0 12 12", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "6", cy: "6", r: "3", fill: "oklch(0.58 0.14 42)", opacity: "0.5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            width: "48",
...
function VillageSilhouette() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full overflow-hidden", style: { marginTop: "auto" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "img",
    {
...
function App() {
  const [selectedPace, setSelectedPace] = reactExports.useState([]);
  const [breathePhaseIndex, setBreathePhaseIndex] = reactExports.useState(0);
  const [isBreatheActive, setIsBreatheActive] = reactExports.useState(false);
  const paceRef = useSectionReveal();
  const promiseRef = useSectionReveal();
  const breatheRef = useSectionReveal();
  ...
  const togglePace = (index2) => {
    setSelectedPace(
      (prev) => prev.includes(index2) ? prev.filter((i) => i !== index2) : [...prev, index2]
    );
  };
  const toggleBreathe = () => {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "section",
          {
            ...
            style: {
              background: "linear-gradient(180deg, oklch(0.96 0.028 68) 0%, oklch(0.945 0.038 60) 50%, oklch(0.88 0.06 55) 100%)"
            },
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-6 max-w-3xl mx-auto pt-20 pb-8", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: "fade-up text-sm tracking-widest uppercase mb-6 font-body",
                    style: { color: "oklch(0.58 0.14 42)", letterSpacing: "0.22em" },
                    children: "✦ Hami Village ✦"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h1",
                  {
                    ...
                    children: "Welcome Home to Hami Village, Yami."
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Your Sukoon has arrived."
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Harsh is here. No rush, no pressure, just us finally sharing the same air. This isn't a test—it's just the two of us coming home."
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(VillageSilhouette, {}) })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "section",
          {
            ...
            style: {
              background: "linear-gradient(180deg, oklch(0.88 0.06 55) 0%, oklch(0.965 0.022 78) 20%)"
            },
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto text-center", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  ...
                  children: [
                    ...
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "There's no wrong answer." })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-4 mb-10", children: PACE_OPTIONS.map((option, i) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      border: isActive ? "1.5px solid oklch(0.58 0.14 42)" : "1.5px solid oklch(0.82 0.045 65)",
                      background: isActive ? "oklch(0.58 0.14 42)" : "oklch(0.955 0.028 72)",
                      color: isActive ? "oklch(0.97 0.015 75)" : "oklch(0.38 0.05 55)",
                      boxShadow: isActive ? "0 4px 20px oklch(0.58 0.14 42 / 0.25)" : "none",
              ...
              hasSelection && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "p",
                    {
                      ...
                      children: [
                        "Yami, whatever you choose is perfect. You can never disappoint me. I'm just here for the",
                        " ",
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: {
                    background: "linear-gradient(145deg, oklch(0.96 0.032 70) 0%, oklch(0.945 0.038 64) 100%)",
                    border: "1px solid oklch(0.84 0.05 65)",
                    boxShadow: "0 8px 48px oklch(0.58 0.14 42 / 0.12), inset 0 1px 0 oklch(1 0 0 / 0.6)"
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "p",
                            {
                              ...
                              children: "My dearest Yami,"
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mb-5", children: [
                            "I see you. Not just the version of you that you think I see — I see ",
                            /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "all of it" }),
                            ". The girl who carries her family on her shoulders with such quiet grace. The one who shows up, every single time, even when it's hard. That responsibility you hold — it doesn't scare me.",
                            " ",
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "strong",
                              {
                                style: { color: "oklch(0.48 0.12 50)", fontWeight: 500 },
                                children: "It makes me admire you more than I can say."
                              }
                            )
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mb-5", children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              ...
                              {
                                style: { color: "oklch(0.48 0.12 50)", fontWeight: 500 },
                                children: "I'm here to stand beside you. Your teammate, always."
                              }
                            ),
                            " ",
                            "When the world feels heavy, I want to be the one who makes it a little lighter — not by taking anything from you, but just by being there."
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mb-5", children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              ...
                              {
                                style: { color: "oklch(0.48 0.12 50)", fontWeight: 500 },
                                children: "I love the real, responsible, perfect girl you are."
                              }
                            ),
                            " ",
                            "The one with the big heart and the quiet worries and the warmth that fills every room."
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mb-8", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              ...
                              {
                                style: { color: "oklch(0.48 0.12 50)", fontWeight: 500 },
                                children: "We go at your speed. Always."
                              }
                            ),
                            " ",
                            "There is nowhere else I'd rather be than right here, in Hami Village, with you."
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(LeafDivider, {}),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "p",
                            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "section",
          {
            ...
            style: {
              background: "linear-gradient(180deg, oklch(0.965 0.022 78) 0%, oklch(0.945 0.035 62) 100%)"
            },
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl mx-auto", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  ...
                  children: "Breathe in Hami Village"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  ...
                  style: { color: "oklch(0.44 0.05 55)" },
                  children: [
                    "For when the overthinking starts. ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Breathe with me, Yami." })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-8", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    "aria-label": isBreatheActive ? "Pause breathing exercise" : "Start breathing exercise",
                    className: "cursor-pointer flex items-center justify-center rounded-full select-none border-0",
                    style: {
                      width: "200px",
                      height: "200px",
                      background: "radial-gradient(circle, oklch(0.72 0.1 45) 0%, oklch(0.58 0.14 42) 100%)",
                      boxShadow: "0 0 40px oklch(0.58 0.14 42 / 0.35)",
                      animation: isBreatheActive ? BREATHE_CSS[currentPhase.label] : void 0,
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        children: isBreatheActive ? currentPhase.label : "Begin"
                      }
                    )
                  }
                ),
                isBreatheActive && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { animation: "fade-up 0.4s ease-out forwards" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: isBreatheActive ? "Just follow the circle. Let your breath find its rhythm." : "Tap the circle to begin."
                  }
                )
              ] })
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "footer",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl mx-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 opacity-50 text-2xl", "aria-hidden": "true", children: "❦" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "I am hell sure about us. I'm not going anywhere."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
